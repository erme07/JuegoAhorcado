...
void intro2();                             //peque�a rese�a del funcionamiento del juego

int select_palabra(char palabra[],char aux[]);   //selecciona la palabra a adivinar, devuelve el tama�o de la palabra
...
int main() {
	...
	system("mode con: cols=93 lines=25");   //defino el tama�o de la consola
